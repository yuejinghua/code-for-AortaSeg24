...
if __name__ == '__main__':
    ...
    predictor.initialize_from_trained_model_folder(
        join(nnUNet_results, 'Dataset006_Bile/nnUNetTrainerUME_LGAG__nnUNetPlans__3d_fullres'),
        use_folds=(0, ),
        checkpoint_name='checkpoint_best.pth',
    )
    predictor.predict_from_files(join(nnUNet_results, 'Dataset006_Bile/imagesTs_30'),
                                 join(nnUNet_results, 'Dataset006_Bile/nnUNetTrainerUME_LGAG__nnUNetPlans__3d_fullres/fold_0/result'),
