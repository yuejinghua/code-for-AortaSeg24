...
def run_training_entry():
    ...
    parser.add_argument('-dataset_name_or_id', type=str,default='265',
    ...
    parser.add_argument('-tr', type=str, required=False, default='nnUNetTrainerUME_LGAG',
    ...
    parser.add_argument('--c', action='store_true', required=False,default=True,
